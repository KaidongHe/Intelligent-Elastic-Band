...
//    QLinearGradient linearGradient(QPoint(0, 0), QPoint(x_move, 0));
    QLinearGradient linearGradient(0, 0, width(), 0);  // 从左到右的渐变
    linearGradient.setColorAt(1.0, QColor("#7A65F6")); // 结束颜色
    linearGradient.setColorAt(m_nAtIndex, QColor("#608CF7")); // 中间颜色
    linearGradient.setColorAt(0.0, QColor("#7CBEC2")); // 起始颜色（蓝色）
